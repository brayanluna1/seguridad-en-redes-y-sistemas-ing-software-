...
para después buscar que había
```
picoplayer@challenge:~$ ls -1
useless
...
```
después descubrí que  no pasaba nada después de unas pruebas, así que seguí buscando y intente mirando la documentación del script y ahí apareció.
```
 man useless
